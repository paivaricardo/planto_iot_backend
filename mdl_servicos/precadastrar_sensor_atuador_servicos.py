...
def precadastrar_sensor_atuador_servico(id_tipo_sensor):
    try:
        ...
        uuid_gerado = dao_precadastrar_sensor_atuador.precadastrar_sensor_atuador_base_dados(id_tipo_sensor)
