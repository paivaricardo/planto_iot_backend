...
def listar_sensores_atuadores_conectados_servico(id_usuario: int):
    """
    ...
    try:
        ...
        return dao_listar_sensores_atuadores_conectados.listar_sensores_atuadores_conectados_bd(id_usuario)
